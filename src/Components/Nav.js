...
return(
    ...
    <nav class="bg-blue-900 py-2 text-white flex justify-between">
      ...
      <ul class="px-28 flex items-center space-x-20 justify-start font-ui-monospace">
        <Link class="text-white  decoration-black  hover:rounded  mx-2 cursor-pointer" to="/Home">Home</Link>
        <Link class="text-white  decoration-black  hover:rounded  mx-2 cursor-pointer" to="/CreateEvent">Create Event</Link>
        <Link class="text-white  decoration-black  hover:rounded  mx-2 cursor-pointer" to="/search">Search Event</Link>
        <Link class="text-white  decoration-black  hover:rounded  mx-2 cursor-pointer" to="/EventTotal">View Events</Link>
    </ul>
    {/* <div className="dropdown">
      ...
      <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        >
        {defaultAccount.length > 10 ? defaultAccount.substr(25, 42) : "Connect Wallet"}
    </li>
    </nav>
